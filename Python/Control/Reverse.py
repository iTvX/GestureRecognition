...
# # 第9个无人机起飞
client.moveToPositionAsync(0, 0, -6, 3, vehicle_name="UAV9")
# # 第8个无人机起飞
client.moveToPositionAsync(0, 0, -6, 2, vehicle_name="UAV8")
# # 第7个无人机起飞
client.moveToPositionAsync(0, 0, -6, 1, vehicle_name="UAV7")

# # 第4个无人机起飞
client.moveToPositionAsync(0, 0, -6, 3, vehicle_name="UAV4")
# # 第5个无人机起飞
client.moveToPositionAsync(0, 0, -6, 2, vehicle_name="UAV5")
# # 第6个无人机起飞
client.moveToPositionAsync(0, 0, -6, 1, vehicle_name="UAV6")

# # 第1个无人机起飞
client.moveToPositionAsync(0, 0, -6, 3, vehicle_name="UAV1")
# # 第2个无人机起飞
client.moveToPositionAsync(0, 0, -6, 2, vehicle_name="UAV2")
# # 第3个无人机起飞
client.moveToPositionAsync(0, 0, -6, 1, vehicle_name="UAV3")
